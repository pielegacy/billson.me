...
My Hermes Agent "Peon" lives on the same laptop which was featured in my [immutable distros](/ramblings/2025-03-14_immutable-distros/) article. Any skills I have with computers are bound entirely to software, as I completely cooked a keyboard replacement which broke the trackpad in the process. Thankfully there's 16 precious gigabytes of RAM in this thing and an i7 so it's good enough to be my home server with the lid perpetually closed.

## The adventures of Peon

![Peon in action](./attachments/peon-intro.jpg)

Hermes' killer feature is the "self-improving" nature of the software. Every message has the potential to write to one of the many Markdown files that backs the agents memory. 
